...
export default class PSB extends React.Component {
   constructor(props){
      super(props);
      this.state = {
        pressedButtonIndex: '',
  ...
  //   await soundObject.loadAsync(require(sl));
  // await soundObject.playAsync();
  //  await soundObject.unloadAsync();
   var soundLink =
   'https://whitehatjrcontent.s3.ap-south-1.amazonaws.com/phones/' +soundChunk +'.mp3';
  //   //   var sLink='media/'+soundChunk+".mp3"
